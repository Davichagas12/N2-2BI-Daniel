<template>
  <footer class="footer">
    <span class="copyright">&copy; 2018 sadtask.com</span>
    <ul class="footer-links list-inline float-right">
      ...
      <li class="list-inline-item"><a href="https://github.com/sadtask/vuejs.spring-boot.mysql" target="_blank">GitHub</a></li>
    </ul>
  </footer>
</template>
