...
describe('RegisterPage.vue', () => {
  ...
  it('should render registration form', () => {
    ...
    expect(wrapper.find('.tagline').text())
      .toEqual('Sadnelson Task Manager')
  ...
  it('should have form inputs bound with data model', () => {
    ...
    const emailAddress = 'sunny@sadtask.com'
  ...
  it('should register when it is a new user', async () => {
    ...
    wrapper.vm.form.emailAddress = 'sunny@sadtask.com'
  ...
  it('should fail it is not a new user', async () => {
    expect.assertions(3)
    // In the mock, only sunny@sadtask.com is new user
    wrapper.vm.form.username = 'ted'
    wrapper.vm.form.emailAddress = 'ted@sadtask.com'
  ...
  it('should fail when the username is invalid', () => {
    ...
    wrapper.vm.form.emailAddress = 'test@sadtask.com'
    wrapper.vm.form.firstName = 'User'
    wrapper.vm.form.lastName = 'Test'
    wrapper.vm.form.password = 'JestRocks!'
    wrapper.vm.submitForm()
