...
public class HibernateUserRepositoryTests {
  ...
  public void save_nullUsernameUser_shouldFail() {
    User inavlidUser = User.create(null, "sunny@sadtask.com", "Sunny", "Hu", "MyPassword!");
  ...
  public void save_nullPasswordUser_shouldFail() {
    User inavlidUser = User.create("sunny", "sunny@sadtask.com", "Sunny", "Hu", null);
    repository.save(inavlidUser);
  }
  ...
  public void save_usernameAlreadyExist_shouldFail() {
    ...
    try {
      User newUser = User.create(username, "new@sadtask.com", "Sunny", "Hu", "MyPassword!");
      repository.save(newUser);
    } catch (Exception e) {
