...
public class DefaultMailManagerTests {
  ...
  public void setUp() {
    ...
    instance = new DefaultMailManager("noreply@sadtask.com", mailerMock, configuration);
  }
  ...
  public void send_nullSubject_shouldFail() {
    instance.send("test@sadtask.com", null, "test.ftl");
  }

  @Test(expected = IllegalArgumentException.class)
  public void send_emptySubject_shouldFail() {
    instance.send("test@sadtask.com", "", "test.ftl");
  }

  @Test(expected = IllegalArgumentException.class)
  public void send_nullTemplateName_shouldFail() {
    instance.send("test@sadtask.com", "Test subject", null);
  }

  @Test(expected = IllegalArgumentException.class)
  public void send_emptyTemplateName_shouldFail() {
    instance.send("test@sadtask.com", "Test subject", "");
  }
  ...
  public void send_validParameters_shouldSucceed() {
    ...
    assertEquals("noreply@sadtask.com", messageSent.getFrom());
