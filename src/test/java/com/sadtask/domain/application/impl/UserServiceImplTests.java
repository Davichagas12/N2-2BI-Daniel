...
import com.sadtask.domain.common.mail.MailManager;
import com.sadtask.domain.common.mail.MessageVariable;
import com.sadtask.domain.model.user.*;
import com.sadtask.domain.model.user.events.UserRegisteredEvent;
...
public class UserServiceImplTests {
  ...
  public void loadUserByUsername_existUsername_shouldSucceed() throws IllegalAccessException {
    ...
    User foundUser = User.create(existUsername, "user@sadtask.com", "Test", "User",
      "EncryptedPassword!");
  ...
  public void register_existingUsername_shouldFail() throws RegistrationException {
    ...
    String emailAddress = "sunny@sadtask.com";
  ...
  public void register_existingEmailAddress_shouldFail() throws RegistrationException {
    ...
    String emailAddress = "existing@sadtask.com";
    String password = "MyPassword!";
    String firstName = "Sunny";
    String lastName = "Hu";
